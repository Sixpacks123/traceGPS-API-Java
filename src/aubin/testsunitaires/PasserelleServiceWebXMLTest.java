...
public class PasserelleServiceWebXMLTest {
	...
	public void testConnecter() {
		...
		msg = PasserelleServicesWebXML.connecter("admin", Outils.sha1("Mdpadmin1"));
		assertEquals("Administrateur authentifié.", msg);
		msg = PasserelleServicesWebXML.connecter("europa", Outils.sha1("Mdputilisateur1"));
	...
	public void testChangerDeMdp() {
		String msg = PasserelleServicesWebXML.changerDeMdp("europa", Outils.sha1("Mdputilisateur1"), "passepasse", "passepassepasse");
		...
		assertEquals("Erreur : authentification incorrecte.", msg);
		msg = PasserelleServicesWebXML.changerDeMdp("europa", Outils.sha1("Mdputilisateur1"), "mdputilisateurrrr", "mdputilisateurrrr");
		assertEquals("Enregistrement effectué ; vous allez recevoir un courriel de confirmation.", msg);
		msg = PasserelleServicesWebXML.changerDeMdp("europa", Outils.sha1("Mdputilisateur1"), "mdputilisateur", "mdputilisateur");
		assertEquals("Enregistrement effectué ; vous allez recevoir un courriel de confirmation.", msg);
	}
	...
	public void testDemanderMdp() {
		...
		msg = PasserelleServicesWebXML.demanderMdp("AubinAubin3 ");
		assertEquals("Vous allez recevoir un courriel avec votre nouveau mot de passe.", msg);
	}
	@Test
	public void testDemanderUneAutorisation() {
		String msg = PasserelleServicesWebXML.demanderUneAutorisation("europa", Outils.sha1("Mdputilisateur1"), "toto", "", "");
		...
		assertEquals("Erreur : authentification incorrecte.", msg);
		msg = PasserelleServicesWebXML.demanderUneAutorisation("europa", Outils.sha1("Mdputilisateur1"), "toto", "coucou", "charles-edouard");
		assertEquals("Erreur : pseudo utilisateur inexistant.", msg);
		msg = PasserelleServicesWebXML.demanderUneAutorisation("europa", Outils.sha1("Mdputilisateur1"), "galileo", "coucou", "charles-edouard");
	...
	public void testRetirerUneAutorisation() {
		...
		assertEquals("Erreur : authentification incorrecte.", msg);
		msg = PasserelleServicesWebXML.retirerUneAutorisation("europa", Outils.sha1("Mdputilisateur1"), "toto", "coucou");
		assertEquals("Erreur : pseudo utilisateur inexistant.", msg);
		msg = PasserelleServicesWebXML.retirerUneAutorisation("europa", Outils.sha1("Mdputilisateur1"), "juno", "coucou");
		assertEquals("Erreur : l'autorisation n'était pas accordée.", msg);
		msg = PasserelleServicesWebXML.retirerUneAutorisation("neon", Outils.sha1("Mdputilisateur1"), "oxygen", "coucou");
		assertEquals("Autorisation supprimée ; oxygen va recevoir un courriel de notification.", msg);
		msg = PasserelleServicesWebXML.retirerUneAutorisation("neon", Outils.sha1("Mdputilisateur1"), "photon", "");
	...
	public void testEnvoyerPosition() throws ParseException {
		...
		msg = PasserelleServicesWebXML.envoyerPosition("europa", Outils.sha1("Mdputilisateur1"), lePoint);
	...
	public void testDemarrerEnregistrementParcours() {
		...
		assertEquals("Erreur : authentification incorrecte.", msg);
		laTrace = new Trace();
		msg = PasserelleServicesWebXML.demarrerEnregistrementParcours("europa", Outils.sha1("Mdputilisateur1"), laTrace);
	...
	public void testArreterEnregistrementParcours() {
		...
		assertEquals("Erreur : authentification incorrecte.", msg);
		msg = PasserelleServicesWebXML.arreterEnregistrementParcours("europa", Outils.sha1("Mdputilisateur1"), 230);
		assertEquals("Erreur : parcours inexistant.", msg);
		msg = PasserelleServicesWebXML.arreterEnregistrementParcours("europa", Outils.sha1("Mdputilisateur1"), 5);
		assertEquals("Erreur : le numéro de trace ne correspond pas à cet utilisateur.", msg);
		msg = PasserelleServicesWebXML.arreterEnregistrementParcours("europa", Outils.sha1("Mdputilisateur1"), 4);
		assertEquals("Erreur : cette trace est déjà terminée.", msg);
		msg = PasserelleServicesWebXML.arreterEnregistrementParcours("europa", Outils.sha1("Mdputilisateur1"), 23);
	...
	public void testSupprimerUnUnParcours() {
		...
		assertEquals("Erreur : authentification incorrecte.", msg);
		msg = PasserelleServicesWebXML.supprimerUnParcours("europa", Outils.sha1("Mdputilisateur1"), 100);
		assertEquals("Erreur : parcours inexistant.", msg);
		msg = PasserelleServicesWebXML.supprimerUnParcours("europa", Outils.sha1("Mdputilisateur1"), 22);
		assertEquals("Erreur : vous n'êtes pas le propriétaire de ce parcours.", msg);
		msg = PasserelleServicesWebXML.supprimerUnParcours("europa", Outils.sha1("Mdputilisateur1"), 30);
